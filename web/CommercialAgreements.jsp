...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/commercialAgreements.css">
...
<body onload="agreementDetails()">
    <form id="myForm" action="CAgreement" method="get">
        <div id="fixed">
            <h3>THE FOLLOWING COMMERCIAL AGREEMENTS ARE IN OPEN STATE</h3>
            </div>
    </form>
        <div class="content">
    ...
    <div class="scrollable-table"> 
          <div id="agreementDetails"><br></div></div>
    
    <script>
        function agreementDetails() {
            var xhr = new XMLHttpRequest();
            xhr.open("GET", "CAgreement", true);
