...
<html>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0" /> 
     <link rel="stylesheet" type="text/css" href="css/serviceContracts.css"> 
    ...
    <body>
        ...
        <form id="myForm" class="form" action="ServiceCServlet" method="post" enctype="multipart/form-data">
            <div id="page1" class="page active">
                ...
                <div class="details">
                    ...
                    <div class="user-details">
                        ...
                        <select id="opti"name="department"required>
                            <option value="select">select</option>
                    ...
                    <div class="user-details">
                     ...
                     <div class="user-details">
                        ...
                        <input type="text" name="securityDesposits" size="40">
                    </div>
                <div class="user-details">
                ...
                <div class="user-details">
                    ...
                    <textarea id="id_remarks" name="remarks" rows="4" cols="50" autocomplete="off" size="200" value=""></textarea>
                </div> 
    ...
    <div class="user-details2">  
        <span class="details2">Service Charges</span>  
        <textarea id="id_remarks_1" name="serviceCharges" rows="auto" cols="auto" autocomplete="off" oninput="checkWordLimit()"></textarea>  
    ...
    <div class="user-details2">  
        ...
        <textarea id="id_remarks_2" name="camChargesS" rows="auto" cols="auto" autocomplete="off" oninput="checkWordLimit()"></textarea>  
        <div id="wordCountMessage_2" class="word-count-message">You have exceeded the 30-word limit.</div>  
    </div>  

    <div class="user-details2">  
        <span class="details2">Utility Charges</span>  
        <textarea id="id_remarks_3" name="utilityChargesS" rows="auto" cols="auto" autocomplete="off" oninput="checkWordLimit()"></textarea>  
        <div id="wordCountMessage_3" class="word-count-message">You have exceeded the 30-word limit.</div>  
    </div>   

    <div class="user-details2">  
        <span class="details2">Performance bank guarantee</span>  
        <textarea id="id_remarks_4" name="performanceBG" rows="auto" cols="auto" autocomplete="off" oninput="checkWordLimit()"></textarea>  
        <div id="wordCountMessage_4" class="word-count-message">You have exceeded the 30-word limit.</div>  
    </div>   

    <div class="user-details2">  
        <span class="details2">Retention bank guarantee</span>  
        <textarea id="id_remarks_5" name="retentionBG" rows="auto" cols="auto" autocomplete="off" oninput="checkWordLimit()"></textarea>  
        <div id="wordCountMessage_5" class="word-count-message">You have exceeded the 30-word limit.</div>  
    </div>   

    <div class="user-details2">  
        <span class="details2">Advance bank guarantee</span>  
        <textarea id="id_remarks_6" name="adavnceBG" rows="auto" cols="auto" autocomplete="off" oninput="checkWordLimit()"></textarea>  
        <div id="wordCountMessage_6" class="word-count-message">You have exceeded the 30-word limit.</div>  
    </div>   

    <div class="user-details2">  
        <span class="details2">Defect Liability period</span>  
        <textarea id="id_remarks_7" name="defectLiability" rows="auto" cols="auto" autocomplete="off" oninput="checkWordLimit()"></textarea>  
        <div id="wordCountMessage_7" class="word-count-message">You have exceeded the 30-word limit.</div>  
    </div>   

    <div class="user-details2">  
        <span class="details2">Latent Defect liability period</span>  
        <textarea id="id_remarks_8" name="latentDefectL" rows="auto" cols="auto" autocomplete="off" oninput="checkWordLimit()"></textarea>  
        <div id="wordCountMessage_8" class="word-count-message">You have exceeded the 30-word limit.</div>  
    </div>     
               <div class="user-details2">
                    <span class="details2">Liquidated Damages</span> 
                    <textarea id="id_remarks_9" name="liquidatedDamages" rows="auto" cols="auto" autocomplete="off" oninput="checkWordLimit()"></textarea>  
...
document.getElementById('id_remarks_5').oninput = function() {
    checkWordLimit('id_remarks_5', 30, 'wordCountMessage_5');
};
...
document.getElementById('id_remarks_9').oninput = function() {
    checkWordLimit('id_remarks_9', 30, 'wordCountMessage_9'); // 1000-word limit for Deviation textarea
};
