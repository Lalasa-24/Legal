...
<body>
    ...
    <button onclick="toggleParts()">Other Fields</button>
                    ...
                    <% for (Map<String, String> row : part2Results) { %>
                        <tr>
                            ...
                            <td><%= row.get("location") %></td>
                                ...
                                <td><%= row.get("serviceCharges") %></td>
                                <td><%= row.get("camChargesS") %></td>
                                <td><%= row.get("utilityChargesS") %></td>
                                <td><%= row.get("performanceBG") %></td>
                                <td><%= row.get("retentionBG") %></td>
                                <td><%= row.get("adavnceBG") %></td>
                                <td><%= row.get("defectLiability") %></td>
                                <td><%= row.get("latentDefectL") %></td>
                                <td><%= row.get("liquidatedDamages") %></td>
