...
public class SContract {
    ...
    public SContract(String agreementNo, Date expiryDate, String documentNature, String agreementType, String partyName, Date executionDate, String agreementStatus) {
