...
@WebServlet("/SUpdateAgreementServlet")  
public class SUpdateAgreementServlet extends HttpServlet {  
...
//        String remarks = request.getParameter("remarks");  
        ...
        try {  
            ...
            String storedProc = "{call UpdateServiceContract(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)}";  
...
//            cstmt.setString(12, remarks);  
            ...
            if (rowsUpdated > 0) {  
                ...
                response.getWriter().println("window.location.href = 'ServiceAgreements.jsp';");  
                ...
                response.getWriter().println("window.location.href = 'SEditPage.jsp';");  
                response.getWriter().println("</script>");  
            } 
