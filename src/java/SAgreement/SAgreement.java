...
@WebServlet("/SAgreement")
public class SAgreement extends HttpServlet {
...
//        out.println("</div>");  
      ...
      out.println("<table class='table1'><tr><th>AGREEMENT ID</th>"  
        ...
        CallableStatement stmt1 = conn.prepareCall("{call GetServiceContracts}");
...
//                String commencementDate = rs1.getString("commencementDate");
                ...
                out.println("<tr>" + 
                            "<td><a href=\"SEditPage.jsp?agreementNo=" + agreementNo + "\">ID" + serialNumber++ + "</a></td>" + 
                            "<td>" + agreementNo + "</td>" + 
                            "<td>" + referenceId + "</td>" + 
...
//                            "<td>" + commencementDate + "</td>" +
        ...
        if (moreResults) {
            ...
            while (rs2.next()) {
                ...
                String serviceCharges = rs2.getString("serviceCharges");
                String camChargesS = rs2.getString("camChargesS");
                String utilityChargesS = rs2.getString("utilityChargesS");
                String performanceBG = rs2.getString("performanceBG");
                String retentionBG = rs2.getString("retentionBG");
                String adavnceBG = rs2.getString("adavnceBG");
                String defectLiability = rs2.getString("defectLiability");
                String latentDefectL = rs2.getString("latentDefectL");
                String liquidatedDamages = rs2.getString("liquidatedDamages");
                ...
                out.println("<tr>" +
                            ...
                            "<td>" + camChargesS + "</td>" +            
                            "<td>" + utilityChargesS + "</td>" +
                            "<td>" + performanceBG + "</td>" +            
                            "<td>" + retentionBG + "</td>" +            
                            "<td>" + adavnceBG + "</td>" +
                            "<td>" + defectLiability + "</td>" +            
                            "<td>" + latentDefectL + "</td>" +            
                            "<td>" + liquidatedDamages + "</td>" +           
                            "<td>" + remarks + "</td>" +
